...
config = {"run_at": None, "browser": "Firefox"}
...
searchBox.send_keys("2027 Winter Term")
result = wait.until(EC.element_to_be_clickable((By.XPATH, "//div[@id='select2-drop']//li[contains(., '2027 Winter Term')]")))
